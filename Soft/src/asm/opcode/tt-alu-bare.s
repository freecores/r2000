...
# $Header: /home/marcus/revision_ctrl_test/oc_cvs/cvs/r2000/Soft/src/asm/opcode/tt-alu-bare.s,v 1.1.1.1 2008-01-13 13:32:17 ameziti Exp $
...
lbd_:	.byte 1, -1, 0, 128
#lbd1_:	.word 0x76543210, 0xfedcba98,0x00000008	# little	endian memory
lbd1_:	.word 0x10325476, 0x98badcfe,0x08000000	# big		endian memory
...
#lhd_:	.half 1, -1, 0, 0x8000	# little	endian memory
lhd_:	.half 0x0001, -1, 0, 0x8000	# big		endian memory
	.text
	addi $v0, $0 ,4	# syscall 4 (print_str)
	la $a0, lh_
#	lui $a0, 0x1000
...
l19:
	...
	addu $0 ,$0 ,$0                # Nop
l18:
#	lui $4 ,0x0040                # to replace la $4 ,l19
